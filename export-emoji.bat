...
%ASESPRITE% -b icon/emoji.ase -scale 3 --format json-array --sheet .thumb/icon/emoji-3x.png --data ~rendered\emoji-3x.json --sheet-type rows -sheet-width 520
...
%ASESPRITE% -b icon/emoji.ase --format json-array --sheet icon/emoji.png --data icon/emoji.json --sheet-type rows -sheet-width 160
